...
print("Dot product of r_hat and c_hat:" , np.dot(vortexSystem[f"inst{j}_{i}"].radVec.flatten(), vortexSystem[f"inst{j}_{i}"].chordVec.flatten()))
...
controlPoints["Uin_blade"] = np.empty((3,3*Ncp))

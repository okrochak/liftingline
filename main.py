...
if choice == '1':
        ...
        if doPlot == 1:
                ...
                fig4 = plt.figure(5,constrained_layout=False,figsize=(8, 4))
...
if choice == '6':
        ...
        normal_vector = np.zeros((3, N_B*Ncp))
        circulation_matrix = np.zeros((N_B*Ncp, N_B*Ncp))
        ...
        while diff > tol:
                ...
                normal_vector[0,:] = 0
                normal_vector[1,:] = np.sin(controlPoints["alpha"])
                normal_vector[2,:] = np.cos(controlPoints["alpha"])

                rhs = np.dot(normal_vector, (U_inf, 0, 0))
